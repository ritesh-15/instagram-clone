...
import com.example.instagram_clone.databinding.FragmentPostsTagsBinding


class PostsTagsFragment : Fragment() {

    private lateinit var binding:FragmentPostsTagsBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?,
    ): View {
        binding = FragmentPostsTagsBinding.inflate(layoutInflater,container,false)
